...
def main():
    ...
    print("[DEMO] Starting Enhanced Semantic Compression Pipeline\n")
    ...
    print(f"[OK] Sampled {len(corpus)} sentences.\n")
    ...
    print("[OK] Saved original embeddings & sentences.\n")

    train_embs, test_embs = train_test_split(
        embeddings, test_size=cfg["test_fraction"], random_state=42
    )
    print(f"[OK] Train/Test split: {len(train_embs)}/{len(test_embs)}\n")

    # FAISS OPQ + PQ
    print("[SEARCH] Training FAISS OPQ + PQ index...")
    ...
    print("[OK] Model saved to artifacts/vqvae.pt\n")
    ...
    print("[OK] Saved sample latents to artifacts/sample_latents.pt\n")
